...
### Fixed
- **WordPress i18n Not Defined**: Fixed `__ is not defined` error
  - Admin class now reads script dependencies from `index.asset.php` generated by webpack
  - Ensures all WordPress script dependencies (wp-i18n, wp-components, etc.) are properly loaded before React app
